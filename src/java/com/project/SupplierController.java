...
public class SupplierController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        List errorMsgs = new LinkedList();
            ...
            String phone = request.getParameter("sContact");
            ...
            String SuppRegistered = SuppDB.addSupplier(Supplier);
            
            if(SuppRegistered.equals("SUCCESS")) //If function returns success string then user will be rooted to Home page
            {
            ...
            {
                request.setAttribute("errMessage", SuppRegistered); //If authenticateUser() function returnsother than SUCCESS string it will be sent to Login page again. Here the error message returned from function has been stored in a errMessage key.
